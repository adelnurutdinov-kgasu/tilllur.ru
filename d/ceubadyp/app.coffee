...
for item in [layer.base, layer.oldAlert, layer.newAlert]
	item.opacity = 0
...
resizeMid = () ->
	figmaView.oldAlert.x = CanvasContent.x + 460
...
resizeRight = () ->
	figmaView.newAlert.x = CanvasContent.x + 460 * 2
...
semi = new Layer
	width: 360
	height: 942
	parent: figmaView.oldAlert
	image: "images/semi.png"




pro.placeBehind(bottomBar.base)
slim.placeBehind(bottomBar.newAlert)
semi.placeBehind(bottomBar.oldAlert)


# print figmaView.newAlert.x
# print figmaView.base.y
...
for item, i in [figmaView.base, figmaView.oldAlert, figmaView.newAlert]
	item.parent = screen

CanvasContent.parent = screen
lineView.parent = screen

textInfoConst.parent = screen
textInfo.parent = screen
