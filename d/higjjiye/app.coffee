...
addTitle(0, "Prototype")
addView(0, "https://tilllur.com/s/nav-panel-fake-ml")

addTitle(1, "Swipe Variants")
addView(1, "images/1.png")
addView(1, "images/2.png")

addComment(2, "Crosses or now?")
addView(2, "images/3.png")
addView(2, "images/4.png")
addView(2, "images/4.png")
