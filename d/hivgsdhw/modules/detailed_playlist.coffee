...
closeDetailedViewTwoWays = (newsDetailedTopView, newsDetailedContent, playlistDetailedView, status_bar_color) ->
	closeDetailedView(newsDetailedTopView, newsDetailedContent, playlistDetailedView, status_bar_color, 1136)
...
closeDetailedView = (newsDetailedTopView, newsDetailedContent, playlistDetailedView, status_bar_color, valueY) ->
...
exports.createPlaylistDetailedPage = (playlistID, status_bar_color) ->
	playlistModel = Artist.playlistsData[playlistID]
	# print playlistModel.image
	...
	# playlistDetailedView.on Events.Tap, (event, layer) ->
...
# 		print "inside #{tap}"
	...
	newsDetailedContentScroll.on Events.ScrollEnd, (event, layer) ->
		# print newsDetailedContentScroll.content.y
		if newsDetailedContentScroll.content.y < gapBottom - gapDelta / 5 * 2
			newsDetailedContentScroll.ignoreEvents = true
			isNewsViewModulating = false
			# closeDetailedView(playlistDetailedView, status_bar_color)
			closeDetailedViewOneWay(newsDetailedTopView, newsDetailedContent, playlistDetailedView, status_bar_color)
