...
for item, i in ["alice", "buttons", "sites"]
	...
	if i == 0
		...
		framerOmniLeft.x = 0
		framerOmniLeft.y = 3
		framerOmniLeft.name = ".framerOmniLeft"
...
# 				shadowColor: "rgba(0,0,0,0.2)"
		...
		framerOmniRight.x = 0
		framerOmniRight.y = 3
		framerOmniRight.name = ".framerOmniRight"
...
# 	if item is "midCanvas"
# 		currentCanvas = new Layer
# 			backgroundColor: "transparent"
# 	else
	...
	currentCanvas.x = canvasScroll.width * (i)
...
newTabView.content.on "change:y", ->
	...
	for row in appIconsMidView.children
		...
		framerMidCanvasContent.y = Utils.modulate(value, [1280, 640], [-640, 0])
