...
# 	scaleIndex = Screen.width / 360 + 0.005
# 	figmaView.scale = scaleIndex
...
for currentLayer in [header, banner, news, weather, district, schedule, stocks, endLayer]
	appViewLayers.push(currentLayer)
	currentLayer.parent = appView.content

distributeLayers.sameMargin
	layers: appViewLayers
	distance: 16
...
# 	print value
	...
	if value <= teaser.states.teaser.y and value >= teaser.states.shown.y
		...
		zen_344_card.y = Utils.modulate(value, [teaser.states.teaser.y, teaser.states.shown.y], [teaser.states.teaser.y, 48 + 48], true)
		...
		darker.opacity = Utils.modulate(value, [teaser.states.shown.y, teaser.states.shown.y + 100], [1, 0], true)
		tabs_zen.opacity = Utils.modulate(value, [teaser.states.shown.y, teaser.states.shown.y + 100], [1, 0], true)
		
		teaser.opacity = Utils.modulate(value, [teaser.states.teaser.y, teaser.states.teaser.y - 200], [1, 1], true)
		teaser.scale = Utils.modulate(value, [teaser.states.teaser.y, teaser.states.teaser.y - 200], [0.96, 1], true)
		...
		tabs_zen.y = value
		zen_344_card.y = value
	
# tabs_zen.placeBehind(zen_344_card)
