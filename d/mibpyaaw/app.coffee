sketch = Framer.Importer.load "imported/fs-ios-adme-pull-to-refresh-dark"
...
sketch["fs_ios_admeiphone_6_pluspull_to_refresh"].parent = screen
sketch["fs_ios_admeiphone_6_pluspull_to_refresh"].scale = 1/3
sketch["fs_ios_admeiphone_6_pluspull_to_refresh"].originX = 0
sketch["fs_ios_admeiphone_6_pluspull_to_refresh"].originY = 0

leave1 = sketch["leave1"]
leave2 = sketch["leave2"]
leave3 = sketch["leave3"]
leave4 = sketch["leave4"]
leave5 = sketch["leave5"]
leave6 = sketch["leave6"]
leave7 = sketch["leave7"]
content = sketch["content"]
spinner = sketch["spinner"]
container = sketch["container"]
symbol = sketch["symbol"]
...
content.on Events.DragEnd, ->
	...
	if content.y < maxPoint
		...
		returnContent.on 'end', ->
			...
			content.animate { properties: {y: contentSavedY}, time: 0.5, delay: 2.5}
