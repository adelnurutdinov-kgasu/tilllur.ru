...
screen = new Layer { width: 375, height: 812, name: "wtf", backgroundColor: "444" }
...
if Utils.isMobile()
	pages = ["images/browser4.png", "images/browser3.png"]
else
	pages = ["images/browser4.png", "images/browser3.png"]
...
preview.addSection("Need Shadow", [
	{ title: "Toggle On/Off", handler: shadowHadler },
])
...
preview.addSection("Other", [
	{ title: "Print Photo URL", handler: printURL },
])
