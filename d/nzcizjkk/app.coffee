...
logo = new Layer
	...
	width: 360
	height: 100
	image: "images/logo%20sign.png"

logo.states =
	"newTab": { opacity: 1, y: 148 }
	"feed": { opacity: 0, y: 148 + 84 }
	"sites": { opacity: 0, y: 148 }

tabs = new Layer
	parent: pageMid
	width: 360
	height: 48
	image: "images/tabs%202020%20july%20(1).png"

tabs.states =
	"newTab": { opacity: 0.2, y: 216 }
...
omnibox = new Layer
	...
	width: 360
	height: 64
	image: "images/omnibox%202020%20july.png"
...
feedContent = new Layer
	...
	width: 360
	height: 608
	image: "images/%D1%81%20%D0%B0%D0%BB%D0%B5%D1%80%D1%82%D0%B0%D0%BC%D0%B8.png"
	...
	if isSwipeToFeed(v)
		...
		l[d] = Utils.modulate(v, g, [l.states[s1][d], l.states[s2][d]],
			true) for [l, d, g] in [[pageBot, "scale", toFeedGap],
									...
									[tabsFeedImage, "opacity", toFeedGapSlow],
