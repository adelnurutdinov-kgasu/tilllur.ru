...
box = new Layer width: 342, x: 450, y: 264, backgroundColor: "transparent", parent: bg

proxyYPos = 1000

floor = new Layer width: 348, height: 200, backgroundColor: "transparent", parent: box
square = new Layer width: 348, height: 200, backgroundColor: "transparent", parent: box
rect = new Layer width: 348, height: 200, backgroundColor: "transparent", parent: box

blinderRight = new Layer width: 62, height: 58, x: 279, image: "images/blinder.png", parent: box
blinderLeft = new Layer width: 40, height: 58, x: 0, image: "images/blinder.png", parent: box, rotation: 180
logo = new Layer width: 60, height: 60, x: 399-8, y: 258, image: "images/logo.png", parent: bg
button = new Layer width: 200, height: 34, x: 790, y: 273, image: "images/button.png", parent: bg
...
floor.html = "<svg viewBox='8 7 348 41'><path fill='none' stroke-linecap='round' stroke-linejoin='round' stroke-width='4' stroke='#eee' stroke-dasharray='0 0' stroke-dashoffset='0' d='M10,33.8745101 L19.2634992,33.8745101 C19.2634992,33.8745101 21.7794838,33.3755025 24.1785811,32.0103041 C26.5776784,30.6451057 26.0896712,29.8599321 27.3682258,29.8599321 C28.3384433,29.8599321 27.9883896,30.5828231 30.1145502,32.0103041 C32.2407108,33.4377851 33.9720507,33.8745101 33.9720507,33.8745101 L38.6990829,33.8745101 L45.4893772,45.0603207 L52.9610264,10 L60.6012703,39.7836341 L69.7879339,33.8745101 L79.0694336,33.8745101 C79.0694336,33.8745101 83.3886601,33.543754 87.4681752,31.073409 C91.5476904,28.6030641 90.6326252,27.1549206 92.8017456,27.1549206 C94.8844318,27.1549206 93.5357677,28.272308 98.4211728,31.073409 C103.306578,33.8745101 106.310893,34.0299131 106.310893,34.0299131 L353.125289,34.0299131'/></svg>"

square.html = "<svg viewBox='8 7 348 41'><path fill='none' stroke-linecap='round' stroke-linejoin='round' stroke-width='4' stroke='#EC1C24' stroke-dasharray='#{square.pathLength} #{square.pathLength}' stroke-dashoffset='#{square.pathLength}' d='M10,33.8745101 L19.2634992,33.8745101 C19.2634992,33.8745101 21.7794838,33.3755025 24.1785811,32.0103041 C26.5776784,30.6451057 26.0896712,29.8599321 27.3682258,29.8599321 C28.3384433,29.8599321 27.9883896,30.5828231 30.1145502,32.0103041 C32.2407108,33.4377851 33.9720507,33.8745101 33.9720507,33.8745101 L38.6990829,33.8745101 L45.4893772,45.0603207 L52.9610264,10 L60.6012703,39.7836341 L69.7879339,33.8745101 L79.0694336,33.8745101 C79.0694336,33.8745101 83.3886601,33.543754 87.4681752,31.073409 C91.5476904,28.6030641 90.6326252,27.1549206 92.8017456,27.1549206 C94.8844318,27.1549206 93.5357677,28.272308 98.4211728,31.073409 C103.306578,33.8745101 106.310893,34.0299131 106.310893,34.0299131 L353.125289,34.0299131'/></svg>"

rect.html = "<svg viewBox='8 7 348 41'><path fill='none' stroke-linecap='round' stroke-linejoin='round' stroke-width='4' stroke='#EEE' stroke-dasharray='#{square.pathLength} #{square.pathLength}' stroke-dashoffset='#{square.pathLength}' d='M10,33.8745101 L19.2634992,33.8745101 C19.2634992,33.8745101 21.7794838,33.3755025 24.1785811,32.0103041 C26.5776784,30.6451057 26.0896712,29.8599321 27.3682258,29.8599321 C28.3384433,29.8599321 27.9883896,30.5828231 30.1145502,32.0103041 C32.2407108,33.4377851 33.9720507,33.8745101 33.9720507,33.8745101 L38.6990829,33.8745101 L45.4893772,45.0603207 L52.9610264,10 L60.6012703,39.7836341 L69.7879339,33.8745101 L79.0694336,33.8745101 C79.0694336,33.8745101 83.3886601,33.543754 87.4681752,31.073409 C91.5476904,28.6030641 90.6326252,27.1549206 92.8017456,27.1549206 C94.8844318,27.1549206 93.5357677,28.272308 98.4211728,31.073409 C103.306578,33.8745101 106.310893,34.0299131 106.310893,34.0299131 L353.125289,34.0299131'/></svg>"
...
# slider.y = Canvas.height - 160*3
# slider.x = Canvas.width - 160*6
# print Screen.width
# slider.centerX()
