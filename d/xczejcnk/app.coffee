...
content2 = new Layer
	...
	height: 731
	x: 360
	image: "images/content2%20(1).png"
...
# 	image: "images/iconVideo.png"
	image: "images/sign%20yandex%20(1).png"
...
for item in [iconVideo, iconYandex]
	item.parent = header
	item.y = 28
	item.x = Align.center()
# 	
...
# iconVideo.stateSwitch("shown")
iconYandex.originX = -0.3
iconYandex.originY = 1.2


iconVideo.states =
	"yandex": { x: 180+54, opacity: 0 }
	"video": { x: 180-22, opacity: 1 }

iconVideo.stateSwitch("yandex")
...
# 	content2.borderRadius = Utils.modulate(v, [360 - gap/2, 360], [24, 0], true)
	...
	l[d] = Utils.modulate(v, g, [l.states[s1][d], l.states[s2][d]],
		true) for [l, d, g] in [[titleYandex, "x", toFeedGap],
								...
								[iconVideo, "x", toFeedGap],
								[iconVideo, "opacity", toFeedGap],
								[iconYandex, "scale", toFeedGap],
	]
