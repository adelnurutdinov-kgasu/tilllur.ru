...
fontAveria = "'Tahoma', 'Verdana', 'Roboto', 'SF Pro Text', 'Helvetica', 'Tahoma', system, sans-serif"
...
resizeView = () ->
	...
	widthView.x = Align.center
	widthView.y = Align.center(-60)

	heightView.x = Align.center
	heightView.y = Align.center(60)
...
preview = new Preview { view: screen, borderRadius: 16, topTheme: "light" }
preview.opacity = 0
