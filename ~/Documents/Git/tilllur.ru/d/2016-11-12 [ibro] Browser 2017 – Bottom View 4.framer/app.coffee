...
keyboard.on Events.SwipeDown, ->
	keyboard.states.switch("hidden", curve: "spring(400, 25, 10)")
...
isOmniboxTransitionStarted = false
isSearchOmniBarPressed = false
...
# 	print globalNavigation.scrollY
	if globalNavigation.scrollY > 640
		if !isOmniboxTransitionStarted
			isOmniboxTransitionStarted = true
			if !isSearchOmniBarPressed
				showNewTabOmniBar()
			else
				showSearchOmniBar()
	else
...
createGlobalNavigation = () ->
	...
	bookmark_1 = new Layer width: 286, height: 368, x: 0, y: 0, image: "images/bookmark 1.png"
	bookmark_2 = new Layer width: 286, height: 368, x: 302, y: 0, image: "images/bookmark 2.png"
	bookmark_3 = new Layer width: 286, height: 368, x: 604, y: 0, image: "images/bookmark 3.png"
	bookmark_4 = new Layer width: 286, height: 368, x: 906, y: 0, image: "images/bookmark 4.png"
...
# view
	...
	focustext.states.add {
		...
		new_tab: { width: 248, x: 164, opacity: 0}
	}
	...
	open_new_tab = new Layer width: 36, height: 36, y: 38, image: "images/open new tab.png"
	
	open_new_tab.states.add {
		base: { x: 736, opacity: 0.0}
		search: { x: 736, opacity: 0.0}
		new_tab: { x: 676, opacity: 1}
	}
	open_new_tab.states.switchInstant "base"
	...
	new_tab_button = new Layer width: 88, height: 112, y: 0
	new_tab_button.states.add {
		base: { x: 748, backgroundColor: "rgba(216,216,216,1)"}
		search: { x: 748, backgroundColor: "rgba(216,216,216,0.01)"}
		new_tab: { x: 662, backgroundColor: "rgba(216,216,216,0.01)"}
	}
	new_tab_button.states.switchInstant "base"



	
	omni_bar_elems = [search_bar_bg, search_bar_shape, focustext, address, http, cancel,  tabs_button, tabs_icom, refresh_icon, clear, protect_icon, new_tab_button, open_new_tab]
...
# 	tabs_icom.on(Events.Click, showTabsHandler)
	...
	new_tab_button.on(Events.Click, openNewTabHandler)
