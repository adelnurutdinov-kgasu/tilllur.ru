...
keyboardSpring = "spring(180, 0, 10)"
fakeTabsDelay = 0.4
...
zenScrollBoundsTop = [0, 180]
zenScrollTopOutput = [omniBgHeight + 24*2, omniBgHeight + 24*2 - 100]
zenScrollTopOutputTop = [omniBgHeight + 24*2, omniBgHeight + 24*2 - 180]
...
zenHandler = (event, layer) ->
	...
	if zenBoard.scrollY <= 0
		bookmarkBlock.y = Utils.modulate(zenBoard.scrollY, zenScrollBoundsTop, zenScrollTopOutput, false)
	else
...
# 		site_buttons_secondary.opacity = Utils.modulate(bookmarkBlock.scrollX, bookmarksScrollBounds, [1, 1], true)
...
# 	back = new Layer width: 358, height: 34, y: 34, image: "images/back.png", opacity: 0, parent: back_button
	...
	zenBoard = new ScrollComponent
		...
		scrollVertical: false
		contentInset:
			top: bookmarkBlock.height + 64+16
		propagateEvents: false

	zen_item_1 = new Layer width: 686, height: 824, x: 0, y: 0, image: "images/zen item 1.png", parent: zenBoard.content
	zen_item_2 = new Layer width: 686, height: 820, x: 0, y: 856, image: "images/zen item 2.png", parent: zenBoard.content
	zen_item_3 = new Layer width: 686, height: 824, x: 0, y: 1708, image: "images/zen item 3.png", parent: zenBoard.content
...
# 		return new_tab
# 	else
# 		localTab = new Layer width: 494, height: 820, x: blankPageRight.x, borderRadius: 8, backgroundColor: "rgba(250,250,250,0.08)", borderWidth: 4, borderColor: "rgba(255,255,255,0.5)", opacity: 0
# 			
# 		localTab.on Events.Click, (event, layer) ->
...
# 	print "created: openNextTabHandlerFromTabs"
...
# 	return_site_button.animate { properties: { opacity: 1 }, curve: tightSpring }
	keyboard.states.switch("hidden", curve: keyboardSpring)
