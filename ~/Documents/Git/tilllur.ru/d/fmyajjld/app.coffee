...
# 		next_step_button_view.off(Events.Click, nextStepHandler)
...
for item in [screen, background_sites, background_bottom_view, sites_bottom_view, bottom_buttons_view, darker, welcome_popup, restart_popup, status_bar, navbar]
